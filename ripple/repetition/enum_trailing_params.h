...
# else /* TODO */
#    define RPP_ENUM_TRAILING_PARAMS(count, param) RPP_ENUM_TRAILING_PARAMS_BYPASS(RPP_LIMIT_EXPR, count, param)
# endif
#
...
# else /* TODO */
#    define RPP_ENUM_TRAILING_PARAMS_BYPASS(s, count, param) RPP_COMMA_IF(count) RPP_ENUM_PARAMS_BYPASS(s, count, param)
# endif
#
