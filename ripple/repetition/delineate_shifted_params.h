...
# else /* TODO */
#    define DETAIL_RPP_DELINEATE_SHIFTED_PARAMS_0(...) DETAIL_RPP_DELINEATE_SHIFTED_PARAMS_0_I((__VA_ARGS__))
#    define DETAIL_RPP_DELINEATE_SHIFTED_PARAMS_1(...) DETAIL_RPP_DELINEATE_SHIFTED_PARAMS_1_I((__VA_ARGS__))
#    define DETAIL_RPP_DELINEATE_SHIFTED_PARAMS_2(...) DETAIL_RPP_DELINEATE_SHIFTED_PARAMS_2_I((__VA_ARGS__))
#    define DETAIL_RPP_DELINEATE_SHIFTED_PARAMS_0_I(x) DETAIL_RPP_DELINEATE_SHIFTED_PARAMS_0_II x
#    define DETAIL_RPP_DELINEATE_SHIFTED_PARAMS_1_I(x) DETAIL_RPP_DELINEATE_SHIFTED_PARAMS_1_II x
#    define DETAIL_RPP_DELINEATE_SHIFTED_PARAMS_2_I(x) DETAIL_RPP_DELINEATE_SHIFTED_PARAMS_2_II x
#    define DETAIL_RPP_DELINEATE_SHIFTED_PARAMS_0_II(c, ...) __VA_ARGS__ ## c
#    define DETAIL_RPP_DELINEATE_SHIFTED_PARAMS_1_II(c, ...) RPP_DEFER(DETAIL_RPP_DELINEATE_SHIFTED_PARAMS_2)(c, RPP_REM __VA_ARGS__)
#    define DETAIL_RPP_DELINEATE_SHIFTED_PARAMS_2_II(c, a, ...) a ## c __VA_ARGS__ ## c
# endif
#
# endif
