...
#  ******************************************************************** */
#
# ifndef RIPPLE_PREPROCESSOR_DETECTION_COMPARE_H
# define RIPPLE_PREPROCESSOR_DETECTION_COMPARE_H
#
...
# /* RPP_COMPARE */
#
# define RPP_COMPARE(a, b) RPP_PRIMITIVE_COMPARE(a, b)
# define RPP_COMPARE_ID() RPP_COMPARE
#
# if CONFIG_RIPPLE_STD
# endif
#
# /* RPP_PRIMITIVE_COMPARE */
#
# define RPP_PRIMITIVE_COMPARE(a, b) \
    RPP_IIF( \
        RPP_BITAND \
            (RPP_IS_NULLARY(RPP_COMPARE_ ## a(()))) \
            (RPP_IS_NULLARY(RPP_COMPARE_ ## b(()))) \
    )( \
    ...
    /**/
# define RPP_PRIMITIVE_COMPARE_ID() RPP_PRIMITIVE_COMPARE
#
# if CONFIG_RIPPLE_STD
# endif
#
