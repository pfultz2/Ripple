...
# define DETAIL_RPP_BIND_DATA_MACRO(e) DETAIL_RPP_BIND_DATA_MACRO_REM RPP_STRIP(e)
#
...
# define DETAIL_RPP_BIND_DATA_INVOKE(m, args) m args
# define RPP_BIND_DATA_INVOKE(e, ...) \
    DETAIL_RPP_BIND_DATA_INVOKE(DETAIL_RPP_BIND_DATA_MACRO(e), \
